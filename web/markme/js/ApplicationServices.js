...
(function () {
    ...
    angular.module("ApplicationServices", [])
        ...
        .provider('Thumbnails', function () {
            var provider = 'markme',
                width = 240,
                height = 180,
                providers = {
                    robothumb: function (url) {
                    ...
                    thumbalizr: function (url) {
                        return "http://api.thumbalizr.com/?url=" + url + "&width=" + width;
                    }
                };
            return{
                setProvider: function (provider_) {
                    if (provider_ in providers) {
                        provider = provider_;
                    }
                },
                $get: function () {
                    return{
                        getThumbnail: function (url) {
                            return providers[provider](encodeURIComponent(url));
                        }
                    };
                }
            };
