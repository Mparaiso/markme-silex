...
namespace App\Services\WebScreenGrabber{
     ...
     */
    class RobothumbScreenGraber extends ScreenGrabber{

        const URL = "http://www.robothumb.com/";
        ...
        function request($url){
            $_url = self::URL."?url=".$url."&size=".$this->width."x".$this->height;
            $context=array(
                "http"=>array(
                    "timeout"=>4,
                    "header"=>"User-Agent: Mozilla/5.0 (Windows NT 6.1) ".
                    "AppleWebKit/537.17 (KHTML, like Gecko) ".
                    "Chrome/24.0.1312.45 Safari/537.17",
                )
            );
