 ...
 */
class Session extends \MarkMe\Entity\Session implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'MarkMe\\Entity\\Session' . "\0" . 'id', '' . "\0" . 'MarkMe\\Entity\\Session' . "\0" . 'data', '' . "\0" . 'MarkMe\\Entity\\Session' . "\0" . 'time');
        }
