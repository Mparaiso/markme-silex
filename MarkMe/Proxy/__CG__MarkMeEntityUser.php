...
class User extends \MarkMe\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'MarkMe\\Entity\\User' . "\0" . 'id', '' . "\0" . 'MarkMe\\Entity\\User' . "\0" . 'username', '' . "\0" . 'MarkMe\\Entity\\User' . "\0" . 'email', '' . "\0" . 'MarkMe\\Entity\\User' . "\0" . 'password', '' . "\0" . 'MarkMe\\Entity\\User' . "\0" . 'created_at', '' . "\0" . 'MarkMe\\Entity\\User' . "\0" . 'updated_at', '' . "\0" . 'MarkMe\\Entity\\User' . "\0" . 'salt', '' . "\0" . 'MarkMe\\Entity\\User' . "\0" . 'last_login', '' . "\0" . 'MarkMe\\Entity\\User' . "\0" . 'bookmarks');
        }
    ...
    public function setLastLogin($last_login)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLastLogin', array($last_login));
    ...
    public function setBookmarks($bookmarks)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBookmarks', array($bookmarks));
    ...
    public function getBookmarks()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBookmarks', array());
